# Equipment Overview
Equipment/Items take the place of jokers. Though we will just show them as cards in the game.

## Equipment Aura 
Equipment can also have Aura with the same affects as the dice aura, except for the addition of ghost aura which is essentially a like a negative joker in Balatro.
...
Horseshoe - $2 - +4 mult
Wedding Ring - $3 - if played hand contains a pair +8 mult
Town Choir - $4 - if played hand contains a three of a kind +12 mult
Deputy Brothers - $4 - if played hand contains a 2 pair +10 mult
...
## Phase 3
Twin Colts - $4 - if played hand contains 2 pair +80 miles
...
## Phase 4
Trail Journal - $5 - adds the number of times the hand has been played this trip as mult
Marked - $6 - +1 mult per hand played without scoring a 6. Scoring a 6 resets mult to 0. Isaac Granger (Demon Hunter) gets +2 per hand.
...
## Phase 6
Rail Splitter - $4 - if played hand contains straight 4 +8 mult
Open Range - $3 - if played hand contains straight 5 +12 mult
...
Bone Charm - $7 - played bone dice have 1 in 2 chance to give x1.5 mult
